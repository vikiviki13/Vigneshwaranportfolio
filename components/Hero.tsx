...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      <Parallax offset={-100} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-lime-500/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-5xl space-y-8">
        ...
        <Parallax offset={80} className="pt-8">
